...
# Histogram Graph Pre-Processing #

######################################################

#' Bar/Histogram Graphs
#'
#' This function creates dataframes which can then be input in to ggplot for
#' creating a histogram/bar plot.
#'
#' @param data Dataframe.  The data that should be analyzed.
